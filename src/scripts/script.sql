...
INSERT INTO Res (ResID, Address, Amenities, NumberOfRooms, Rent, Type) VALUES
    ('res02', '456 Elm St', 'Gym, Parking', 2, 1200, 'OOO');
INSERT INTO Res (ResID, Address, Amenities, NumberOfRooms, Rent, Type) VALUES
...
(SELECT DISTINCT Type FROM Res where Type =
'Off Campus' OR Type = 'On Campus')
MINUS
(SELECT DISTINCT L.ListingType
 FROM Lister L WHERE L.ListerID = U.UserID));
